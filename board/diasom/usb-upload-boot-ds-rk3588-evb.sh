...
if [ ! -f $ROOT/barebox-diasom-rk3588-btb-evb.img ]; then
	echo "\"barebox-diasom-rk3588-btb-evb.img\" image is not found!"
	exit 1
fi
...
sudo $ROOT/rk-usb-loader -d $ROOT/barebox-diasom-rk3588-btb-evb.img
