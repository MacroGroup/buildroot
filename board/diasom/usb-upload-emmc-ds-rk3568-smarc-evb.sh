...
if [ ! -f $ROOT/ds-rk3568-smarc-evb-sdcard.img ]; then
	echo "\"ds-rk3568-smarc-evb-sdcard.img\" image is not found!"
	exit 1
fi
...
sudo $ROOT/fastboot -i 7531 -S 128M flash emmc $ROOT/ds-rk3568-smarc-evb-sdcard.img
