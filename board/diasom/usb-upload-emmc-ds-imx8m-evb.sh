...
if [ ! -f $ROOT/ds-imx8m-evb-sdcard.img ]; then
	echo "\"ds-imx8m-evb-sdcard.img\" image is not found!"
	exit 1
fi
...
sudo $ROOT/fastboot -i 7531 -S 128M flash emmc $ROOT/ds-imx8m-evb-sdcard.img
