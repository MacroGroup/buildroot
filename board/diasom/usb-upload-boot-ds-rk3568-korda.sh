...
if [ ! -f $ROOT/barebox-diasom-rk3568-korda.img ]; then
	echo "\"barebox-diasom-rk3568-korda.img\" image is not found!"
	exit 1
fi
...
sudo $ROOT/rk-usb-loader -d $ROOT/barebox-diasom-rk3568-korda.img
